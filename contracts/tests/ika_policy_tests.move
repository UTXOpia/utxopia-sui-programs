...
module utxopia::ika_policy_tests {
    ...
    fun approve_then_consume() {
        ...
        // request + approve
        {
            ...
            redemption::request_redemption(&cap, &mut pool, &mut queue, bytes(34, 0x51), 50_000, 1_000);
    ...
    fun rejects_amount_over_cap() {
        ...
        // amount > 1 BTC
        redemption::request_redemption(&cap, &mut pool, &mut queue, bytes(34, 0x51), 200_000_000, 1_000);
    ...
    fun rejects_fee_over_cap() {
        ...
        redemption::request_redemption(&cap, &mut pool, &mut queue, bytes(34, 0x51), 50_000, 100_000);
